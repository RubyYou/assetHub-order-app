...
export default {
  ...
  computed: mapState({
    ...
    isConfigSet: state => state.config.isSet,
    isPostDataSet: state => state.config.postData,
    isFormDataSet: state => state.config.formData,
    accounts: state => state.config.accounts
  }),
  mounted() {
